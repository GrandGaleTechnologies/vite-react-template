# React 19 + Vite + Tailwind CSS v4 + ShadCN UI Starter Template
...
Install icons from [animateicons.vercel.app](https://animateicons.vercel.app/):

```bash
node install-icon.js <icon-name>
```
